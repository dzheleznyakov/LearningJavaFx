...
public class LightingUtil {
    public static GridPane getPropertyControllers(Lighting effect) {
        Slider surfaceScaleSlider = getSlider(0, 10, effect.getSurfaceScale(), effect.surfaceScaleProperty());
        Slider diffuseConstantSlider = getSlider(0, 2, effect.getDiffuseConstant(), effect.diffuseConstantProperty());
        Slider specularConstantSlider = getSlider(0, 2, effect.getSpecularConstant(), effect.specularConstantProperty());
        Slider specularExponentSlider = getSlider(0, 40, effect.getSpecularExponent(), effect.specularExponentProperty());
